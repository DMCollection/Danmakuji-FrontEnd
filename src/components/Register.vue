            ...
            <div id="area-reg">
                ...
                <div class="block r">
                    <div class="area-reg">
                        ...
                        <el-form v-show="!isRegSuccess" id="form-reg" class="form" :model="registerData" status-icon :rules="rules" ref="reg">
                        <h3 class="title">注册 Darker</h3>
                        <div class="area">
                        <el-form-item prop="nick">
                            <el-input id="ipt-username-reg" name="name" v-model="registerData.nick" type="text" auto-complete="off" class="regname name l error" placeholder="请输入昵称" required="required"></el-input>
                        </el-form-item>
                        <span class="clearfix"></span>
                        </div>
                        <div class="area">
                        <el-form-item prop="email">
                            <el-input id="ipt-mobile-reg" name="mobile" v-model="registerData.email" type="text" auto-complete="off" class="mobile l error" placeholder="请输入邮箱" required="required"></el-input>
                        </el-form-item>
                        <span class="clearfix"></span>
                        </div>
                        <div class="area">
                        <el-form-item prop="password">
                            <el-input id="ipt-pwd-reg" name="password" v-model="registerData.password" type="password" auto-complete="off" placeholder="请输入密码，6-20位" class="password l error" required="required"></el-input>
                        </el-form-item>  
                        <span class="clearfix"></span>
                        </div>
                        <div class="area">
                        <el-form-item prop="dupwd">
                            <el-input id="ipt-repwd-reg" name="dupwd" v-model="registerData.dupwd" type="password" auto-complete="off" placeholder="确认密码" class="re-password l error" required="required"></el-input>
                        </el-form-item>
                        <span class="clearfix"></span>
                        </div>
