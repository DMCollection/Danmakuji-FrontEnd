<template>
    <div class="list-item reply-wrap" :id="'r-'+reply.reply.reply.replyId">
        ...
        <div class="con">
            <div class="user">
                <a :href="'#/user/'+reply.reply.user.uid" target="_blank" class="name vip-red-name">{{reply.reply.user.nick}}</a>
            ...
            <padding-box v-show="reply.reply.totalSize>10" v-on:changeSubRepliesPage="changeSubRepliesPage" :sub_replies="reply.replies" :view_more="view_more" :root_reply="reply"></padding-box>
